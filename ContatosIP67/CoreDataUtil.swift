...
class CoreDataUtil {
    ...
    func getEntity<T: NSManagedObject>() -> T {
        if #available(iOS 10, *) {
            let obj = T(context: persistentContainer.viewContext)
            return obj
        } else {
...
//        if #available(iOS 10, *) {
//            let obj = T(context: CoreDataUtil.context)
//            return obj
//        } else {
//            guard let entityDescription = NSEntityDescription.entity(forEntityName: NSStringFromClass(T.self), in: CoreDataUtil.context) else {
//                fatalError("Core Data entity name doesn't match.")
//            }
//            let obj = T(entity: entityDescription, insertInto: CoreDataUtil.context)
//            return obj
//        }
//    }
